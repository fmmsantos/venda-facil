...
public class VendaServiceTest {
	...
	public void testarcalcularValorTotalVenda() {
      ...
      Venda venda = new Venda();
		...
		item1.setDesconto(new BigDecimal("3.00"));
		
		item2.setId(2);
		item2.setValorTotal(new BigDecimal("32.50"));
		item2.setDesconto(new BigDecimal("4.00"));
		
		item3.setId(3);
		item3.setValorTotal(new BigDecimal("10.00"));
		item3.setDesconto(new BigDecimal("2.00"));
		...
		Assert.assertEquals(new BigDecimal("57.50"), venda.getValorTotal());
		Assert.assertEquals(new BigDecimal("57.50"), totalVenda);
		
	
	}
	@Test
	public void aplicarDescontoTipoCliente() {
